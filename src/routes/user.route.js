...
import { registerUser, userLogin, userLogout, refreshUserAccessToken, updateLoginPassword, updateAvatarImage, updateCoverImage, updateUserDetails, getUserChannelProfile } from "../controllers/user.controller.js";
...
router.route("/get-channel-details").get(VerifyJWT, getUserChannelProfile);
